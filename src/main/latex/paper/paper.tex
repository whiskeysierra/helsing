...
\section{Apache\texttrademark Hadoop}
auch wenn Hadoop nach den Google Papers (GFS , MapReduce, Bigtable, etc) modelliert wurde lohnt ein Vergleich um Tenzing bewerten zu können. Google veröffentlicht Papers, aber keinen Code! Hadoop = Open Source Alternative
...
Google BigTable Clone \cite{HBase} \cite{BigTable}

\subsection{Apache\texttrademark Pig}
vgl. Sawzall \cite{Sawzall}? (http://wiki.apache.org/incubator/PigProposal)
...
Scheint Datenquellen-spezifische Eigenschaften nicht zu berücksichtigen. nur RDBMS
