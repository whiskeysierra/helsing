...
\centering
  \begin{tabular}{| l | l | l | l |}
   ...
   9 & Stockholm \\ \hline
  \end{tabular}
\caption{Beispiel einer Projektion}
...
\centering
  \begin{tabular}{| l | l | l | l |}
   ...
   7 & Los Angeles & 3831868 & 4 \\ \hline
  \end{tabular}
\caption{Beispiel einer Selektion}
\label{tab:selection}
\end{table}
\end{minipage}
\end{minipage}
...
\centering
  \begin{tabular}{| l | l | l | l |}
    ...
    3 & 1343121 \\ \hline
  \end{tabular}
\caption{Beispiel einer Gruppierung mit Aggregatfunktion}
\label{tab:group}
\end{table}
...
\end{minted}
\caption{Query für eine Vereinigung}
\label{lst:union}
\end{listing}
...
\centering
  \begin{tabular}{| l | l | l | l |}
   ...
   9 & Stockholm  \\ \hline
    ...
    5 & Japan \\ \hline
  \end{tabular}
\caption{Beispiel einer Vereinigung}
\label{tab:union}
\end{table}
\end{minipage}
\end{minipage}
...
\centering
  \begin{tabular}{| l | l | l | l |}
   ...
   Lyon & France \\ \hline
  \end{tabular}
\caption{Beispiel eines Inner Joins}
...
ON city.country_id = country.id;
\end{minted}
\caption{Beispiel eines Left Joins}
\label{lst:left-join}
\end{listing}
...
ON city.country_id = country.id;
\end{minted}
\caption{Beispiel eines Right Joins}
...
ON city.country_id = country.id;
\end{minted}
\caption{Beispiel eines Full Joins}
\label{lst:full-join}
\end{listing}
...
\end{minted}
\caption{Beispiel eines Self Joins}
\label{lst:self-join}
\end{listing}
