...
commodity hardware, terabyte datasets, data analysis, processing, simplified programming model, fail safe

\subsection{Funktionsweise}
fp-style, map per input line, (combine), sort, reduce per key
